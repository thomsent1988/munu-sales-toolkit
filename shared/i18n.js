(function(){
  ...
  var STRINGS = {
    no: {
      ...
      bfySub:"Velg det som er relevant for din bedrift, og se effekten bygge seg opp i sanntid.",

      bfyTransBoxTitle:"Transaksjonskostnad",
      bfyTransOmsetning:"Omsetning per år",
      bfyTransAntall:"Antall transaksjoner per år",
      bfyTransKostPerTrans:"Kostnad per transaksjon",
      bfyTransKonkHead:"Nåværende leverandør",
      bfyTransKonkProsent:"Transaksjonsprosent",
      bfyTransKonkLisens:"Lisenser per måned",
      bfyTransKonkHw:"Hardware per måned",
      bfyTransMunuHead:"Munu",
      bfyTransMunuProsent:"Transaksjonsprosent",
      bfyTransMunuLisens:"Lisenser per måned",
      bfyTransMunuHw:"Hardware per måned",
    ...
    en: {
      ...
      bfyEyebrow:"MUNU - NO HIDDEN COSTS",
      bfyTitleHtml:"Find the <em>leak</em>",
      bfySub:"Toggle what's relevant for your business, and watch the effect build up in real time.",

      bfyTransBoxTitle:"Transaction cost",
      bfyTransOmsetning:"Revenue per year",
      bfyTransAntall:"Transactions per year",
      bfyTransKostPerTrans:"Cost per transaction",
      bfyTransKonkHead:"Current provider",
      bfyTransKonkProsent:"Transaction fee",
      bfyTransKonkLisens:"Licenses per month",
      bfyTransKonkHw:"Hardware per month",
      bfyTransMunuHead:"Munu",
      bfyTransMunuProsent:"Transaction fee",
      bfyTransMunuLisens:"Licenses per month",
      bfyTransMunuHw:"Hardware per month",
